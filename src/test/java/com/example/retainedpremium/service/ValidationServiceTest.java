...
class ValidationServiceTest {
    ...
    void validateFileInfos_validFiles_passed() {
        ...
        ValidationResult result = service.validateFileInfos(fileInfos);
    ...
    void validateFileInfos_emptyList_error() {
        ValidationResult result = service.validateFileInfos(Collections.emptyList());
    ...
    void validateCompanyData_validData_passed() {
        ...
        ValidationResult result = service.validateCompanyData(data, "A01.xlsx");
    ...
    void validateCompanyData_emptyCompanyCode_error() {
        ...
        ValidationResult result = service.validateCompanyData(data, "test.xlsx");
